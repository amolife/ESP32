    ...
    public static EPaperDisplay[] getDisplays()
    {
        if (array == null)
        {
            array = new EPaperDisplay[]
            {
                ...
                new EPaperDisplay(648,480,1, "5.83b V2 e-Paper"),    //29
                new EPaperDisplay(128,296,1, "2.9b V2 e-Paper"),    //30
                new EPaperDisplay(200,200,1, "1.54b V2 e-Paper"),  //31
                new EPaperDisplay(104,214,1, "2.13b V3 e-Paper"),   //32
            };
        }
