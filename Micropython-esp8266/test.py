...
rst = Pin(5)
busy = Pin(16)
spi = SPI(1, baudrate=8000000, polarity=0, phase=0)##, sck=sck, miso=miso, mosi=mosi)

e = epaper1in54b_fuxk.EPD(spi, cs, dc, rst, busy)
e.init()
...
#e.display_frame(bytearray(0x01), bytearray(0x02))
# 
# # --------------------
# 
